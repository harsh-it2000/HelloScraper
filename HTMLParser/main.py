def torSearcher(url):
    ...
    print("Getting ...", url)
    result = session.get(url).text # Different public IP
    # print(requests.get("http://httpbin.org/ip").text) # Normal public IP
 ...
 url = "http://t2m3ckcm737bhebo4m3ks7r5ztu6m6c7g6x753dgoqcetvg3dkrbieid.onion"
 torSearcher(url)
